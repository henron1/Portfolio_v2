...
export const article = {
  author: 'Henry Neal',
  date: '2022-09-05',
  title: 'Crafting an accessible and responsive UI',
  description:
    'An accurate description will eventually be put here once I start writing articles, but for now this rambling along with the occasional lorem ipsum will suffice in its stead',
}
...
An accurate description will eventually be put here once I start writing articles, but for now this rambling along with the occasional lorem ipsum will suffice in it's stead
